...
According the above code truck, we can get that there are `r nrow(enty_without_vending)` stations are ADA compliant.
...
mr_trash_df = 
  read_excel("./Data/Trash-Wheel-Collection-Totals-7-2020-2.xlsx", skip = 1) %>% 
  janitor::clean_names() %>% 
